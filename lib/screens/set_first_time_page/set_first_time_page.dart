...
class SetFirstTimePage extends StatefulWidget {
  ...
  @override
  State<SetFirstTimePage> createState() => _SetFirstTimePageState();
}

class _SetFirstTimePageState extends State<SetFirstTimePage> {
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<AppCubit, AppCubitStates>(
      listener: (context, state) {
       if (state is AppSetFirstTimeSuccessState)
        {
          Navigator.push(
            context,
            PageTransition(
                              ...
                              FFButtonWidget(
                                onPressed: () {
                                  if (formKey.currentState!.validate()) {
                                    AppCubit.get(context).setFirstTime(context,
